...
export const Sidebar = () => {
  return (
    <div>
      <div className="h-full p-3 space-y-2 w-20 lg:w-60 bg-teal-500">
        <div className="flex items-center p-2 space-x-4">
          ...
          />
          <div>
            <h2 className="hidden lg:flex text-lg font-semibold">Leroy Jenkins</h2>
            <span className="flex items-center space-x-1">
              <a
                rel="noopener noreferrer"
                href="#"
                className="text-xs hidden lg:flex hover:underline "
              >
                View profile
              </a>
            </span>
          ...
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            ...
            <li>
              ...
              >
                ...
                <span className="hidden lg:flex">Chat</span>
              </a>
            </li>
            <li>
              <a
